...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _CRUD = __webpack_require__(244);
	...
	var _NoMatch = __webpack_require__(257);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            { to: '/', className: 'ma2 pa2 navy hover-white b f3' },
	            'CRUD'
	          ),
	          _react2.default.createElement(
	            _reactRouterDom.Link,
	            { to: '/todos', className: 'ma2 pa2 navy hover-white b f3' },
	            'TODOS'
	          ),
	          _react2.default.createElement(
	            _reactRouterDom.Switch,
	            null,
	            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/', component: _CRUD2.default }),
	            _react2.default.createElement(_reactRouterDom.Route, { path: '/todos', component: _Todos2.default }),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _MemoryRouter2 = __webpack_require__(234);

	var _MemoryRouter3 = _interopRequireDefault(_MemoryRouter2);

	var _NavLink2 = __webpack_require__(235);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _MemoryRouter2 = __webpack_require__(219);
	...
	var _StaticRouter2 = __webpack_require__(228);

	var _StaticRouter3 = _interopRequireDefault(_StaticRouter2);

	var _Switch2 = __webpack_require__(229);

	var _Switch3 = _interopRequireDefault(_Switch2);

	var _matchPath2 = __webpack_require__(225);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _matchPath = __webpack_require__(225);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Route = __webpack_require__(224);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _todoList = __webpack_require__(245);

	var _todoList2 = _interopRequireDefault(_todoList);

	var _todoInput = __webpack_require__(255);
	...
	var CRUD = function CRUD(_ref) {
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				'h4',
				{ className: 'f4 dark-blue' },
				'Currently on CRUD Route'
			),
			_react2.default.createElement(_todoInput2.default, null),
			_react2.default.createElement(_todoList2.default, { todos: todos, show: true })
		);
	};
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(CRUD);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _todoItem = __webpack_require__(251);
	...
	var renderTodoItems = function renderTodoItems(todos, show) {
		if (!todos.length) return _react2.default.createElement(
			'h1',
			{ className: 'f2 gray' },
			'No Todos Exist Yet !!'
		);
		var items = todos.map(function (todo) {
			return _react2.default.createElement(_todoItem2.default, { name: todo.name.toUpperCase(), completed: todo.completed, key: randomKey().slice(-5), id: todo.id, show: show });
		});
		return _react2.default.createElement(
			'ul',
			{ className: 'list pl0 ml0 center w-50 ba b--light-silver br2' },
			items
		);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var v4 = __webpack_require__(250);
	...
	var TodoItem = function (_Component) {
	  ...
	  _createClass(TodoItem, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'li',
	        { className: (0, _classnames2.default)("ph3 pv3 bb b--light-silver f2 shadow-5 br5", { 'bg-white': !completed, 'bg-light': completed }) },
	        show && _react2.default.createElement(
	          'span',
	          { className: 'tr pointer dim pa2' },
	          _react2.default.createElement('img', { width: '25', height: '25', src: '../style/edit.png', onClick: this.handleUpdate })
	        ),
	        _react2.default.createElement(
	          'label',
	          { htmlFor: name, className: (0, _classnames2.default)("lh-copy hover-gray pointer user-select-none word-break w-50", { 'green': !completed, 'red strike': completed }),
	            onClick: function onClick() {
	              return show && _this2.props.toggleCompleted(_this2.props.id);
	            } },
	          name
	        ),
	        show && _react2.default.createElement(
	          'span',
	          { className: 'tr pointer dim pa2' },
	          _react2.default.createElement('img', { width: '25', height: '25', src: '../style/close.png', onClick: function onClick() {
	              return _this2.props.deleteTodo(_this2.props.id);
	            } })
	        )
	      );
	    }
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    toggleCompleted: function toggleCompleted(id) {
	      return dispatch((0, _actions.toggleTodoAction)(id));
	    },
	    deleteTodo: function deleteTodo(id) {
	      return dispatch((0, _actions.removeTodoAction)(id));
	    },
	    toggleUpdate: function toggleUpdate(update, value) {
	      return dispatch((0, _actions.toggleUpdateAction)(update, value));
	    }
	  };
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.toggleTodoAction = exports.removeTodoAction = exports.toggleUpdateAction = exports.createTodoAction = undefined;
	...
	var createTodoAction = function createTodoAction(name) {
		return { type: _types2.default.CREATE_TODO, name: name };
	};

	var toggleUpdateAction = function toggleUpdateAction(update, value) {
		return { type: _types2.default.TOGGLE_UPDATE, update: update, value: value };
	};

	var removeTodoAction = function removeTodoAction(id) {
		return {
			type: _types2.default.DELETE_TODO,
			id: id
		};
	};
	...
	var toggleTodoAction = function toggleTodoAction(id) {
		return {
			type: _types2.default.TOGGLE_TODO,
			id: id
		};
	};

	exports.createTodoAction = createTodoAction;
	exports.toggleUpdateAction = toggleUpdateAction;
	exports.removeTodoAction = removeTodoAction;
...
/***/ (function(module, exports) {
	...
	var SEARCH_TODO = "SEARCH_TODO";
	var TOGGLE_UPDATE = "TOGGLE_UPDATE";
	var TOGGLE_TODO = "TOGGLE_TODO";

	exports.default = { CREATE_TODO: CREATE_TODO, DELETE_TODO: DELETE_TODO, SEARCH_TODO: SEARCH_TODO, TOGGLE_UPDATE: TOGGLE_UPDATE, TOGGLE_TODO: TOGGLE_TODO };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TodoInput = function (_Component) {
		...
		_createClass(TodoInput, [{
			...
			key: 'render',
			value: function render() {
				return _react2.default.createElement('input', { className: 'w-50 pa2 ma2 tc f2 gray shadow-2', ref: 'todo',
	...
	var mapStateToProps = function mapStateToProps(state) {
		return { value: state.value, update: state.update };
	};

	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
		return {
			createTodo: function createTodo(name) {
				return dispatch((0, _actions.createTodoAction)(name));
			},
			toggleUpdate: function toggleUpdate(update, value) {
				return dispatch((0, _actions.toggleUpdateAction)(update, value));
			}
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(TodoInput);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Todos = function (_Component) {
	  ...
	  function Todos(props) {
	    ...
	    _this.displayAllTodos = _this.displayAllTodos.bind(_this);
	    _this.filteredTodos = _this.filteredTodos.bind(_this);
	    _this.completedTodos = _this.completedTodos.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(Todos, [{
	    ...
	    key: 'displayAllTodos',
	    value: function displayAllTodos() {
	      var todos = this.props.todos;
	      var selected = [true, false, false];
	      this.setState({ todos: todos, selected: selected });
	    }
	  }, {
	    key: 'filteredTodos',
	    value: function filteredTodos() {
	    ...
	    key: 'completedTodos',
	    value: function completedTodos() {
	      var todos = this.props.todos.filter(function (todo) {
	        return todo.completed;
	      });
	      var selected = [false, false, true];
	      this.setState({ todos: todos, selected: selected });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'h4',
	          { className: 'f4 dark-green' },
	          'Currently on Todos Route'
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'buttons' },
	          _react2.default.createElement(
	            'button',
	            { onClick: this.displayAllTodos, className: (0, _classnames2.default)("br3 pa3 ma3 bg-white", { "bg-yellow": this.state.selected[0] }) },
	            'All'
	          ),
	          _react2.default.createElement(
	            'button',
	            { onClick: this.filteredTodos, className: (0, _classnames2.default)("br3 pa3 ma3 bg-white", { "bg-yellow": this.state.selected[1] }) },
	            'Filtered'
	          ),
	          _react2.default.createElement(
	            'button',
	            { onClick: this.completedTodos, className: (0, _classnames2.default)("br3 pa3 ma3 bg-white", { "bg-yellow": this.state.selected[2] }) },
	            'Completed'
	          )
	        ),
	        _react2.default.createElement(_todoList2.default, { todos: this.state.todos, show: false })
	      );
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var todos = [{ id: randomKey(), name: "Learn Redux", completed: false }, { id: randomKey(), name: "Don't Listen to any advice ", completed: true }, { id: randomKey(), name: "Learn React", completed: false }, { id: randomKey(), name: "Always be an asshole", completed: true }];
	...
	var todoReducer = function todoReducer() {
		...
		switch (action.type) {
			case _types2.default.CREATE_TODO:
				{
					var id = randomKey();
					var name = action.name;
					var completed = false;
					var todo = { id: id, name: name, completed: completed };

					var _todos = [].concat(_toConsumableArray(state.todos), [todo]);
					return _extends({}, state, { todos: _todos });
				}
			case _types2.default.TOGGLE_UPDATE:
				{
					var update = action.update;
					var value = action.value;
					return _extends({}, state, { update: update, value: value });
				}
			case _types2.default.DELETE_TODO:
				{
					var _todos2 = state.todos.filter(function (todo) {
						return todo.id !== action.id;
					});
					return _extends({}, state, { todos: _todos2 });
				}
			case _types2.default.SEARCH_TODO:
				{
					var filteredTodos = state.todos.filter(function (todo) {
						return todo.name.toLowerCase().trim().includes(action.name.toLowerCase().trim());
					});
					return _extends({}, state, { filteredTodos: filteredTodos });
				}
			case _types2.default.TOGGLE_TODO:
				{
					var _todos3 = state.todos.map(function (todo) {
